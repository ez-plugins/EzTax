...
public class ExemptionsSubcommand implements Subcommand {
    private final ExemptionService exemptionService;
    private final MessageManager messageManager;

    public ExemptionsSubcommand(org.bukkit.plugin.Plugin plugin, ExemptionService exemptionService, Messages messages) {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        if (!sender.hasPermission("eztax.command.exemptions")) {
